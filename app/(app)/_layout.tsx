...
function TabGlyph({kind,active}:{kind:AfterGlyphKind;active:boolean}){return <AfterGlyph kind={kind} active={active} size={23}/>;}
...
export default function AppLayout(){
  ...
  return <Tabs screenOptions={{headerShown:false,sceneStyle:{paddingTop:androidTop,backgroundColor:'#FFF9F3'},tabBarHideOnKeyboard:true,tabBarActiveTintColor:'#314A38',tabBarInactiveTintColor:'#8D8178',tabBarLabelStyle:{fontSize:10.5,fontWeight:'800',marginTop:1},tabBarItemStyle:{paddingTop:4},tabBarStyle:{borderTopWidth:0,backgroundColor:'#FFFDF9',paddingTop:3,elevation:12,shadowColor:'#2B2926',shadowOpacity:.08,shadowRadius:16,shadowOffset:{width:0,height:-4}}}}>
